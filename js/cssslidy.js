var cssSlidy = function (newOptions) {
	...
	var imgCount = images.length, // count the number of images in the slide, including the new cloned element
		...
		css.innerHTML += options.slidySelector + " figure { float: left; margin: 0; position: relative; display: inline-block; width: " + basePercentage + "%; heigth: auto; }\n ";
		...
		if (options.slidyDirection == "right") {
			css.innerHTML += position + "% { left: -" + ((imgCount - 1) * 100) + "%; }\n";
